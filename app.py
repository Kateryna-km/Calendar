...
from models import app,\
    Calendar, Event, User
from schemas import UserToCreate, EventToCreate, user_schema, event_schema, events_schema, Group, _id, userdata_schema, \
    EventToUpdate, userdataa_schema
...
def create_user():
    ...
    return {'id': new_user.id, 'access_token': access_token, 'refresh_token': refresh_token}
